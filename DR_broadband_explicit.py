...
# -*- coding: utf-8 -*-
"""
explicit probe and object update
@author: Arjun Rana
"""
#%%
import sys
...
if rank == 0: 
    print '=============starting DR explicit reconstruction============='
...
#        collected_mags = collected_mags.T #for some reason, Allreduce transposes in this context
        ...
        aperture += ds * np.conj(u_old) * diff_exit_wave 
    ...
    if (np.mod(itt,25) == 0 and itt > 0):
        ...
        if rank == 0:
            saveString = "DR_explicit_output_%s_%s" % (file_name, job_id)
